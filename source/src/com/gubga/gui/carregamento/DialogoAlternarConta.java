...
public class DialogoAlternarConta extends Janela {
	...
	public DialogoAlternarConta(JanelaPrincipal janelaPrincipal) {
		super();
		...
		configurarEventos();
		adicionarElementos();
		definirPropriedades(janelaPrincipal, "Alternar Conta de Usuário", null);
	}
	...
	public DialogoAlternarConta getThis() {
		return this;
	}
